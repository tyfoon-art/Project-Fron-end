...
หมายเหตุ: ผู้ใช้งานควรตรวจสอบความถูกต้องของข้อมูลส่วนตัวให้เป็นปัจจุบันอยู่เสมอ โดยเฉพาะอีเมลและเบอร์โทรศัพท์ เพื่อให้สามารถติดต่อประสานงานหรือยืนยันความเป็นเจ้าของสิ่งของได้อย่างถูกต้องและรวดเร็ว

## 6. คู่มือการใช้งานระบบสำหรับผู้ดูแลระบบ (Admin)
### 1. แดชบอร์ดภาพรวม

หลังจากเจ้าหน้าที่เข้าสู่ระบบสำเร็จ ระบบจะนำไปยังหน้า **แดชบอร์ดภาพรวม** ซึ่งเป็นหน้าหลักสำหรับติดตามสถานะการดำเนินงานของระบบ Lost & Found ICT และสรุปข้อมูลสำคัญเกี่ยวกับสิ่งของสูญหาย สิ่งของที่รอการตรวจสอบ และประวัติการส่งมอบคืนเจ้าของ

![หน้าแดชบอร์ด](images/admin-dashboard.png)

หมายเหตุ : หน้าแดชบอร์ดเป็นศูนย์กลางการจัดการระบบสำหรับเจ้าหน้าที่ โดยออกแบบมาเพื่อช่วยให้สามารถติดตามสถานะสิ่งของ คำร้อง และประวัติการส่งมอบได้อย่างรวดเร็ว ช่วยลดขั้นตอนการทำงานและเพิ่มประสิทธิภาพในการบริหารจัดการสิ่งของสูญหายภายในหน่วยงาน
